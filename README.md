#l Z哥战法的 -Python 实现（更新版）

> **更新时间：2025-11-21** –
>
> **🆕 新增Web可视化界面！**
> - ✅ 一键运行战法，实时查看选股结果
> - ✅ 交互式K线图（含MA5/10/20/30/60均线）
> - ✅ 多战法对比功能
> - ✅ 响应式设计（支持PC/平板/手机）
>
> **快速启动**: `./start_web.sh` 然后访问 http://127.0.0.1:5000
>
> **详细说明**: [Web界面使用说明.md](Web界面使用说明.md) | [Web系统测试报告.md](Web系统测试报告.md)
...
> 5. 新增 **出坑战法（BreakoutPreviousHighSelector）**：前高突破+放量确认战法。
